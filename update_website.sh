...
ssh -i aws-new-key-sg-new.pem ubuntu@13.127.99.82 'sudo docker cp /home/ubuntu/ranjanravi.com/booking/. tomcat:/usr/local/tomcat/webapps/ROOT/'
...
ssh -i aws-new-key-sg-new.pem ubuntu@13.127.99.82 'sudo docker cp /home/ubuntu/ranjanravi.com/checkspell/. checkspell:/usr/share/nginx/html/'
